 ...
 */
import {clamp as mathClamp, RAD_TO_DEG, DEG_TO_RAD} from "./math";
 ...
 * @param {Object} [self=this] 関数内で this として参照される値。デフォルトは自分自身。
 */
export function step(limit, step, fn, self) {
 ...
 * @param {Object} [self=this] 関数内で this として参照される値。デフォルトは自分自身。
 */
export function upto(t, fn, self) {
 ...
 * @param {Object} [self=this] 関数内で this として参照される値。デフォルトは自分自身。
 */
export function downto(t, fn, self) {
 ...
 * @return {Number} 最大値
 */
export function max(value) { return Math.max(this, value) }
 ...
 * @return {Number} 最小値
 */
export function min(value) { return Math.min(this, value) }
 ...
 */
export function clamp(min, max) { return mathClamp(this, min, max) }
 ...
 */
export function pow(exponent) { return Math.pow(this, exponent) }
