...
export class Vector2 {
   ...
   * 
   * @example
   * var v1 = new Vector2(2, 1);
   * var v2 = new Vector2(2, 3);
   * console.log(v1.pointingAngle(v2)); // 1.5707... = Math.PI/2
   * 
   * @param {Vector2} v ベクトル
   * @returns {number}
   */
  pointingAngle(v) {
    return Vector2.pointingAngle(this, v)
  }
   ...
   */
  pointingDegree(v) {
    return Vector2.pointingDegree(this, v)
  }
   ...
   * var v1 = new Vector2(2, 1);
   * var v2 = new Vector2(2, 3);
   * console.log(Vector2.pointingAngle(v1, v2)); // 1.5707... = Math.PI/2
   *
   * @param {Vector2} lhs ベクトル
   * @param {Vector2} rhs ベクトル
   * @returns {number}
   */
  static pointingAngle(lhs, rhs) {
   ...
   * var v1 = new Vector2(2, 1);
   * var v2 = new Vector2(2, 3);
   * console.log(Vector2.pointingDegree(v1, v2)); // 90
   *
   * @param {Vector2} lhs ベクトル
   * @param {Vector2} rhs ベクトル
   * @returns {number}
   */
  static pointingDegree(lhs, rhs) {
    return Vector2.pointingAngle(lhs, rhs) * RAD_TO_DEG;
  }
