...
export class Element extends EventDispatcher {
   ...
   *
   * @param  {Function} cb 各childを引数とするコールバック関数。trueを返すと伝播中断
   * @return {this}
   */
  childForEach(cb) {
   ...
   */
  deepChildForEach(cb) {
    Element.recurseChildren(this, cb, false)
    return this;
  }
